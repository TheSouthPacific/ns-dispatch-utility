...
LOGGING_CONFIG = {
    ...
    "formatters": {
        "NSDUFormatter": {"format": "[%(asctime)s %(name)s %(levelname)s] %(message)s"}
    },
    "handlers": {
        "console": {
...
SUBCATEGORIES_3 = {"policy": "305", "news": "315", "opinion": "325", "campaign": "385"}
...
SUBCATEGORIES_8 = {"gameplay": "835", "reference": "845"}

CATEGORIES = {
    "factbook": {"num": "1", "subcategories": SUBCATEGORIES_1},
